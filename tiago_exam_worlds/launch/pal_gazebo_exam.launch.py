...
def start_gzserver(context, world_name, *args, **kwargs):
    pkg_path = get_package_share_directory("tiago_exam_worlds")
    priv_pkg_path = ""
    try:
        priv_pkg_path = get_package_share_directory("tiago_exam_worlds_private")
    except Exception:
        pass

    world_name = context.perform_substitution(world_name)
...
def generate_launch_description():
    ...
    start_gazebo_server_cmd = OpaqueFunction(function=start_gzserver, args=[world_name])
